...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-wl2zmw");
    			add_location(h1, file$3, 1, 4, 14);
    			attr_dev(header, "class", "svelte-wl2zmw");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 11, 8, 208);
    			attr_dev(h2, "class", "svelte-rz5cry");
    			add_location(h2, file$2, 12, 8, 234);
    			attr_dev(p0, "class", "svelte-rz5cry");
    			add_location(p0, file$2, 13, 8, 263);
    			attr_dev(header, "class", "svelte-rz5cry");
    			add_location(header, file$2, 10, 4, 190);
    			...
    			add_location(img, file$2, 16, 8, 329);
    			attr_dev(div0, "class", "image svelte-rz5cry");
    			add_location(div0, file$2, 15, 4, 300);
    			attr_dev(p1, "class", "svelte-rz5cry");
    			add_location(p1, file$2, 19, 8, 412);
    			attr_dev(div1, "class", "content svelte-rz5cry");
    			add_location(div1, file$2, 18, 4, 381);
    			attr_dev(a, "href", a_href_value = "mailto:" + /*email*/ ctx[4]);
    			add_location(a, file$2, 22, 8, 468);
    			add_location(button0, file$2, 23, 8, 514);
    			add_location(button1, file$2, 24, 8, 553);
    			attr_dev(footer, "class", "svelte-rz5cry");
    			add_location(footer, file$2, 21, 4, 450);
    			attr_dev(article, "class", "svelte-rz5cry");
    			add_location(article, file$2, 9, 0, 175);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*address*/ 32) set_data_dev(t4, /*address*/ ctx[5]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['title', 'subtitle', 'imageUrl', 'description', 'email', 'address'];
    	...
    	return [title, subtitle, imageUrl, description, email, address];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$1, 6, 0, 101);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1uydz46");
    			add_location(main, file, 32, 0, 1127);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	const meetups = [
    		{
    			...
    			description: "In this meetup, we will have some experts that teach you how to use Svelte",
    			imageUrl: "https://i.insider.com/60144316a7c0c4001991dde6?width=800&format=jpeg&auto=webp",
    		...
    		},
    		{
    			...
    			subtitle: "Learn to code in 1 hours",
    			description: "In this meetup, we will have some experts that teach you how to use Svelte and then will go deep dive",
    			imageUrl: "https://miro.medium.com/v2/resize:fit:1400/1*XZrU5omVCZPZXuYv2AZnog.jpeg",
    			address: "27th Nerd Road, 32523 Cincinnati",
